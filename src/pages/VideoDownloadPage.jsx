      ...
      useEffect(() => {
        const fetchVideoInfo = async () => {
          ...
          try {
            ...
            if (data.success && data.result && data.result.download_url && data.result.title) {
              ...
              console.error("API Success False or No Result/Download URL/Title (Video):", data, "URL Sent:", youtubeUrlForApi);
